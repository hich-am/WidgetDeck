...
export const BADGE_CATALOG: Record<BadgeId, Badge> = {
  ...
  streak_3:      { id: "streak_3",      name: "On a Roll",       description: "3-day active streak",                  icon: "S03" },
  streak_7:      { id: "streak_7",      name: "Week Warrior",    description: "7-day active streak",                  icon: "S07" },
  ...
  xp_100:        { id: "xp_100",        name: "Getting Started", description: "Reached 100 XP",                      icon: "XP100" },
  xp_500:        { id: "xp_500",        name: "Power User",      description: "Reached 500 XP",                      icon: "XP500" },
